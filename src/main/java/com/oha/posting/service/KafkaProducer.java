...
public class KafkaProducer {
    ...
    private final KafkaTemplate<String, PostReportEvent> postReportTemplate;
    ...
    public void sendPostReportEvent(PostReportEvent event) {
        this.postReportTemplate.send("post-report-"+profile, event);
        log.info("post-report send: {}", event);
    }
